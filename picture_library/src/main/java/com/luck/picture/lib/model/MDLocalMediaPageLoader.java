 ...
 */
public final class MDLocalMediaPageLoader {
    private static final String TAG = MDLocalMediaPageLoader.class.getSimpleName();
    /**
     * unit
     */
    ...
    public MDLocalMediaPageLoader(Context context, PictureSelectionConfig config) {
